/****************************************************************************
** Meta object code from reading C++ file 'class.hh'
**
...
#include "../src/class.hh"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'class.hh' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Class_t, stringdata0) + ofs \
...
const QMetaObject Class::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Class.data,
      qt_meta_data_Class,  qt_static_metacall, nullptr, nullptr}
};
...
void *Class::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Class.stringdata0))
